...
def test_hartree_fock_gradient(method='hf'):
    ...
    quax_deriv = np.asarray(quax.core.derivative("geom.xyz", basis_name, method, deriv_order=1, options=options)).reshape(-1,3)
    quax_partial0 = quax.core.partial_derivative("geom.xyz", basis_name, method, deriv_order=1, partial=(0,))
